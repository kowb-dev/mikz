...
require_once get_stylesheet_directory() . '/inc/features/custom-stock-status.php';
require_once get_stylesheet_directory() . '/inc/features/404-assets.php';
require_once get_stylesheet_directory() . '/inc/features/checkout-minimal.php';
