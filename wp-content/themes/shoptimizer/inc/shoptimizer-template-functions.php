...
/**
 * Conditionally remove page sidebar based on customizer setting.
 */
if ( ! function_exists( 'shoptimizer_remove_page_sidebar' ) ) {
	function shoptimizer_remove_page_sidebar() {
		$shoptimizer_layout_page_sidebar = shoptimizer_get_option( 'shoptimizer_layout_page_sidebar' );
		
		if ( 'no-page-sidebar' === $shoptimizer_layout_page_sidebar ) {
			remove_action( 'shoptimizer_page_sidebar', 'shoptimizer_pages_sidebar', 10 );
		}
	}
}
add_action( 'wp', 'shoptimizer_remove_page_sidebar', 20 );