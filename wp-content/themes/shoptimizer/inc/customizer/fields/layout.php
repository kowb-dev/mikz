...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'choices'   => array(
			...
			'no-page-sidebar'    => esc_html__( 'None', 'shoptimizer' ),
		),
	)
);

// Conditional description for "None" option
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		'type'     => 'custom',
		'settings' => 'shoptimizer_layout_page_sidebar_none_description',
		'section'  => 'shoptimizer_layout_section_sidebars',
		'default'  => '<div style="background: #f0f6fc; border-left: 4px solid #0073aa; padding: 12px; margin: 8px 0; border-radius: 3px;">
			<p style="margin: 0; color: #1d2327;"><strong>Tip:</strong> You can also manually select which page template to use on a per-page basis. <a href="https://www.commercegurus.com/docs/shoptimizer-theme/how-page-templates-work/" target="_blank" style="color: #0073aa; text-decoration: underline;">Learn about page templates</a></p>
		</div>',
		'priority' => 10,
		'active_callback' => array(
			array(
				'setting'  => 'shoptimizer_layout_page_sidebar',
				'value'    => 'no-page-sidebar',
				'operator' => '==',
			),
		),
	)
